...
//
const BotName = 'IRW4N BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/irwan_x_yans'; // Nama Instagramlu cok
const whatsapplu = 'wa.me/628882611841'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/G7e4uNotT4S8eq5beORDhz'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/G7e4uNotT4S8eq5beORDhz'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
